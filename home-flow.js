...
function openHomeCases(){switchPanel('home-panel');document.getElementById('home-cases')?.scrollIntoView({behavior:matchMedia('(prefers-reduced-motion: reduce)').matches?'instant':'smooth'});}
